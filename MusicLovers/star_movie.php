...
<div id="container">
    ...
    <div id="navigator">
    <hr style="margin:0px;"/>
    	&nbsp;&nbsp;<a href="index.php">Home</a> >><a href="star.php">Stars</a> <b>>> <?php echo $star;?></b>
        <hr style="margin:0px;"/>
	</div>
    <?php
    ...
    <div id="section2">
		...
		<div id="folder_head"><?php echo $star;?></div>
        <table style="background-color:#FFF; padding:5px;">
        	<tr style="text-align:center;">
            	<td>        
                    <?php
                    include('include/dbconfig.php');
                    $sel = "SELECT * from folder WHERE star1='$star' OR star2='$star' AND category='Bollywood Music' order by year desc LIMIT 12";
                    $result_set = mysql_query($sel);
					while($row = mysql_fetch_array($result_set)){
                        ?>
        		    <tr id="movie_folder">
            			<td style="padding:30px; width:220px;">
                            <a href="song.php?category=<?php echo 'Bollywood Music';?>&folder_id=<?php echo $row['id']; ?>" style="padding:30px;"><img src="uploads/<?php echo $row['category'];?>/<?php echo $row['name'];?>/<?php echo $row['poster']; ?>"></a><br>
