...
<div id="container">
    ...
    <div id="navigator">
    <hr style="margin:0px;"/>
    	&nbsp;&nbsp;<a href="index.php">Home</a> >> <a href="director.php">Directors</a> <b>>> <?php echo $director;?></b>
        <hr style="margin:0px;"/>
	</div>
    <?php
    ...
    <div id="section2">
		...
		<div id="folder_head"><?php echo $director;?></div>
        <table style="background-color:#FFF; padding:5px;">
        	<tr style="text-align:center;">
            	<td>        
                    <?php
                    include('include/dbconfig.php');
                    $sel = "SELECT * from folder WHERE director='$director' AND category='Bollywood Music' order by year desc LIMIT 12";
